...
for dataset_name in "${dataset_names[@]}"; do
  ...
  models="models/DT_${FOLDS}F_${METRIC}_${dataset_name}.model models/GBT_${FOLDS}F_${METRIC}_${dataset_name}.model models/RF_${FOLDS}F_${METRIC}_${dataset_name}.model models/LR_${FOLDS}F_${METRIC}_${dataset_name}.model models/MLP_${FOLDS}F_${METRIC}_${dataset_name}.model"
